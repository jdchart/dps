...
class Classifier:
    ...
    def append_training_data(self, audio_file_path, class_name):
    ...
    def _get_model(self, input_dims, num_classes):
    ...
    def _audio_analysis(self, sound_file):
